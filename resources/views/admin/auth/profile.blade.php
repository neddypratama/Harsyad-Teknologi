...
@section('breadcrump')
    <nav aria-label="breadcrumb">
        ...
        <h6 class="font-weight-bolder mb-0">Contact Company</h6>
    @endsection
        ...
        <div class="row mb-5">
            ...
            <div class="col-lg-9 mt-lg-0 mt-4">
                    ...
                    <div class="row justify-content-center align-items-center">
                        <div class="col-sm-auto col-4">
                            <div class="avatar avatar-xl position-relative">
                                <img src="{{ asset('template/assets/img/bruce-mars.jpg') }}"
                ...
                <div class="card mt-4" id="basic-info">
                    ...
                    <form id="update-form" method="post" action="{{ url('profile/' . auth()->user()->id) }}" autocomplete="off">
                ...
                <div class="card mt-4" id="password">
                    ...
                    <form method="post" action="{{ url('profile-password/' . auth()->user()->id) }}"
                        autocomplete="off">
                        <div class="card-body">
                            @csrf
                            @method('put')
                ...
                <div class="card mt-4" id="delete">
                    ...
                    <form action="{{ route('profile.destroy', auth()->user()->id) }}" method="POST" id="delete-form">
                        @csrf
                        @method('DELETE')
                        ...
                        <div class="card-body d-sm-flex pt-0">
                            <div class="d-flex align-items-center mb-sm-0 mb-4">
                                ...
                                @if ($errors->has('check_delete'))
                                    <span class="invalid-feedback" role="alert">
                                        {{ $errors->first('check_delete') }}
                                    </span>
                                @endif
                            </div>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            @if ($errors->has('password') || $errors->has('old_password') || $errors->has('password_confirmation'))
                document.getElementById('password').scrollIntoView();
            @endif
        });
        document.addEventListener("DOMContentLoaded", function() {
            @if ($errors->has('check_delete'))
                document.getElementById('delete').scrollIntoView();
            @endif
        });
    </script>
